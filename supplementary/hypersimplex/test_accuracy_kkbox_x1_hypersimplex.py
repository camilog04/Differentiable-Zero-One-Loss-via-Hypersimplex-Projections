...
import logging
logging.basicConfig(
    filename="kkbox_hypersimplex.log", 
    level=logging.INFO
)
...
infile_train = "../data/kkbox_x1/train.csv"
infile_valid = "../data/kkbox_x1/valid.csv"
...
res = {}
start = time.time()
logging.info("Hypersimplex traning starting (AUC, kkbox)...")
bst = lgb.train(
    params, train_data, 
