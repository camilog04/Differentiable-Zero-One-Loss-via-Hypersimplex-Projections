...
import logging
logging.basicConfig(
    filename="flight_delay_hypersimplex.log", 
    level=logging.INFO
)
...
infile_train = "../data/flight_delay/train.libsvm"
infile_valid = "../data/flight_delay/valid.libsvm"
...
res = {}
start = time.time()
logging.info("Hypersimplex traning starting (AUC, flight_delay)...")
bst = lgb.train(
    params, train_data, 
