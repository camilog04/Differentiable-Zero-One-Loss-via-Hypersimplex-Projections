...
import logging
logging.basicConfig(
    filename="KDD10_hypersimplex.log", 
    level=logging.INFO
)
...
infile_train = "../data/KDD10/train.libsvm"
infile_valid = "../data/KDD10/valid.libsvm"
...
res = {}
start = time.time()
logging.info("Hypersimplex traning starting (AUC, KDD10)...")
bst = lgb.train(
    params, train_data, 
