...
def main(args):
    ...
    train_ds = CIFAR10("/home/camilo1/research/multiclass/data", train=True, transform=train_transform, download=True)
    train_dl = DataLoader(
        train_ds, batch_size=args.batch_size, shuffle=True, num_workers=4
    )

    test_ds = CIFAR10("/home/camilo1/research/multiclass/data", train=False, transform=test_transform, download=True)
    test_dl = DataLoader(
